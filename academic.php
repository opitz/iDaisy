...
//	Last changes: Matthias Opitz --- 2013-06-12
//
//==================================================================================================
$version = "130308.2";
$version = "130416_n.1";	// using start and end term for Leave
$version = "130424.1";		// fixed a bug in sums calculation of staff list
$version = "130425.1";		// added Grade and FTE to staff list
$version = "130508.1";		// excluding casual payroll staff (grade = X99) by default, added checkbox to include them
$version = "130531.1";		// using start_term_id in leave table
$version = "130607.1";		// adding DAISY Edit for Post (Overseers only)
$version = "130612.1";		// fixed a bug with start dates of a post
...
{
	if($webauth_code) show_single_staff_details(get_employee_id_from_webauth($webauth_code));
	else show_no_mercy();
}
...
function print_academic_help()
{
	...
	print "<TABLE>";
		...
		print "<TR>";
			print "<TD>";
				print "<B><FONT COLOR=DARKBLUE>Include staff not ACTV this year</FONT></B>:";
			print "</TD><TD>";
				print "Select this to include staff members that have no ACTV post with the department in the selected academic year.";
			print "</TD>";
		print "</TR><TR>";

		print "<TR>";
			print "<TD>";
				print "<B><FONT COLOR=DARKBLUE>Show full details</FONT></B>:";
			print "</TD><TD>";
