...
//==================================================================================================
//
//	iDAISY Leave Report index page
//	Last changes: Matthias Opitz --- 2013-05-31
//
//==================================================================================================
$version = "130531.1";	// a start...

include 'leave_include_list.php';
...
if(current_user_is_in_DAISY_user_group("Editor")) show_leave_query();
else show_no_mercy();
...
//	define column width in output table
		$table_width = array('Department' => 250, 'Committee' => 200, 'Type' => 100, 'Member' => 250, 'Component' => 350, 'Role' => 300, 'Bkbl' => 60, 'Start Term' => 100, 'End Term' => 100);
//		print_table($table, $table_width, $_POST['show_line_numbers']);
