...
//==================================================================================================
//
//	iDAISY SES Attendance index page
...
elseif($query_type == 'module') show_module_list();
...
//		$excel_title = "Query_".str_replace(" ", "_", $department['department_name']);
		$excel_title = "PGR Module Attendance Report";
...
//	$debug = 2;
	...
	module_query_form();
	print_attendance_intro();
}

//-----------------------------------------------------------------------------------------
function print_attendance_intro()
{
	$text = "<B>The report shows enrolled students for each PGR Module and their attendance where recorded.</B><BR />
Just click on 'Go!' to get a list of all modules of the department. <BR />	";
...
//-----------------------------------------------------------------------------------------
function print_attendance_help()
{
	print "<HR>";
