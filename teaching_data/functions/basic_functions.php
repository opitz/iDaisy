...
{
	$text = "<B>Teaching Data Reports</B>
	<P>
	...
	<B>Assessment Units:</B> A list of all Assessment Units owned by the department.<P>
	...
	<B>Teaching Instances:</B> This report will list all Teaching Instance records of the selected academic year. For each instance it will show the term, the related employee (aka lecturer, including her/his HR Employee Number),
	...
	The edited file may then be uploaded again to update the data in DAISY (please note that column names must not be changed for this to work!).
	<P>
	More Information can be found in the <A HREF=https://daisy.socsci.ox.ac.uk/help/index.php/Teaching_Data_Upload TARGET=new>DAISY Help Wiki</A>.
	";
