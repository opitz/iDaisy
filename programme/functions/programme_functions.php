...
//			$row['Actual AU Stint'] = number_format(au_stint_share($ay_id, $au_id),2);
...
//			$row['Actual AU Hours'] =  number_format(au_hours($ay_id, $au_id),2);
			...
			$row['Actual AU Hours'] =  number_format($hours['actual'],2);
		}
		else
		{
...
//	amend Degree Programme percentage
		if($au_dp_students > 0) 
		{
			...
			$row['DP Norm Stint'] = number_format($au_dp_students / $au_students * au_norm_stint_share($ay_id, $au_id), 2);
			$row['DP Actual Stint'] = number_format($au_dp_students / $au_students * au_stint_share($ay_id, $au_id), 2);
//			$row['DP Stint Share'] = number_format($au_dp_students / $au_students * $row['Actual AU Stint Share'], 2);
		}
		else
		{
			$row['DP %'] = number_format(0, 2);
			$row['DP Norm Stint'] = number_format(0, 2);
			$row['DP Actual Stint'] = number_format(0, 2);
...
//			$sum_au_stint_per_dept[$row['AU provided by']] = $sum_au_stint_per_dept[$row['AU provided by']] + $row['Actual AU Stint'];
			...
			$sum_dp_norm_stint_per_dept[$row['AU provided by']] = $sum_dp_norm_stint_per_dept[$row['AU provided by']] + $row['DP Norm Stint'];	
			$sum_dp_stint_per_dept[$row['AU provided by']] = $sum_dp_stint_per_dept[$row['AU provided by']] + $row['DP Actual Stint'];	
...
//			$au_stint_sum = $au_stint_sum + $row['Actual AU Stint'];
			...
			$dp_norm_stint_sum = $dp_norm_stint_sum + $row['DP Norm Stint'];
			$dp_stint_sum = $dp_stint_sum + $row['DP Actual Stint'];
...
//		$row['Actual AU Stint'] = $sum_au_stint_share_per_dept[$department];
		...
		$row['DP Norm Stint'] = $sum_dp_norm_stint_per_dept[$department];
		$row['DP Actual Stint'] = $sum_dp_stint_per_dept[$department];
...
//		$row['Actual AU Stint'] = "<B><U>" . $au_stint_share_sum . "</U></B>";
		...
		$row['DP Norm Stint'] = "<B><U>" . $dp_norm_stint_sum . "</U></B>";
		$row['DP Actual Stint'] = "<B><U>" . $dp_stint_sum . "</U></B>";
