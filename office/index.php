...
//==================================================================================================
//
//	iDAISY Offce Holding Report index page
//	Last changes: Matthias Opitz --- 2013-03-11
//
//==================================================================================================
$version = "130311.1";

include 'office_include_list.php';
...
$header = "Office Holding Report";

if($_POST['query_type'] == 'office') 
{
	$header = "Office Holding Report";
	$table = office_report();
}
...
if(current_user_is_in_DAISY_user_group("Editor")) show_office_query();
else show_no_mercy();
