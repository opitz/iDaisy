...
//	print the form to support the query
{
	...
	$office_q = $_POST['office_q'];										// get cttee_title_q
	...
	print start_row(0) . "Office:" . new_column(0) . "<input type='text' name = 'office_q' value='$office_q' size=50>" . end_row();		
...
function show_office_list()
{
	...
	$office_q = $_POST['office_q'];													// get office_q
	$office_holder_q = $_POST['office_holder_q'];									// get office_holder_q

//	define column width in output table
	$table_width = array('Department' => 300, 'Office' => 450, 'Holder' => 250, 'Percentage' => 60, 'Notes' => 300, 'Approval' => 100);
...
WHERE 1=1
	...
	if($office_q) $query = $query."AND off.title LIKE '%$office_q%' ";
