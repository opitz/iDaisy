...
//	print the form to support the query
{
	...
	$parameter['department_code'] = $department_code		;					// get department_code
...
//	display the option checkboxes
	...
	print new_column(60);
		if ($show_unrelated) print "<input type='checkbox' name='show_unrelated' value='TRUE' checked='checked'>";
...
//	print the form to support the query
{
	...
	$parameter['department_code'] = $_POST['department_code'];					// get department_code
	$parameter['fullname_q'] = $_POST['fullname_q'];								// get fullname_q
	$parameter['ay_id'] = $_POST['ay_id'];											// get ay_id
	$parameter['query_type'] = $_POST['query_type'];								// get query_type
	...
	print start_row(0) . "Staff Member:" . new_column(0) . "<input type='text' name = 'fullname_q' value='$fullname_q' size=50>" . end_row();		
	print "</TABLE>";
...
//	print the query
{
	...
	print start_row(0) . "Code:" . new_column(0) . "<input type='text' name = 'dp_code_q' value='$dp_code_q' size=50>" . end_row();		
	print start_row(0) . "Title:" . new_column(0) . "<input type='text' name = 'dp_title_q' value='$dp_title_q' size=50>" . end_row();		
	print "</TABLE>";
