...
//	Show a department column only when no department was selected in for the query
		...
		$query = $query."
			...
			CONCAT('<A HREF=$this_page?au_id=', au.id, '&ay_id=$ay_id&department_code=$department_code>',au.title,'</A>') AS 'Title'
...
//	Show a department column only when no department was selected in for the query
		...
		$query = $query."
			au.assessment_unit_code AS 'Code',
			CONCAT('<A HREF=$this_page?au_id=', au.id, '&department_code=$department_code>',au.title,'</A>') AS 'Title'
...
CONCAT('<A HREF=$this_page?au_id=', au.id, '&ay_id=$ay_id>',au.title,'</A>') AS 'Assessment Unit',
