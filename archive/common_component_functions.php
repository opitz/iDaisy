...
//--------------------------------------------------------------------------------------------------------------
function show_component_specs0($tc_data)
...
//	get the assessment units for each component
		...
		{			
			...
			if(current_user_is_in_DAISY_user_group("Super-Administrator") OR (current_user_is_in_DAISY_user_group("Editor") AND employee_is_affiliated($e_id, $dept_id)))
