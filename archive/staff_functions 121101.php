...
//	write out all $_POST attributes as hidden input
	...
	if (has_supervising($e_id, $ay_id)) 
	{
		if($_POST["show_supervising"])
		{
			...
			$html = $html."<input type='submit' value=' Hide Supervising'>";
		} else
		{
			$html = $html."<input type='hidden' name='show_supervising' value=1>";
			$html = $html."<input type='submit' value='Show Supervising'>";
		}
	} else
	{
		$html = $html."<input type='hidden' name='show_supervising' value=0>";
			$html = $html."<input type='submit' value='  NO Supervising  '>";
	}
	$html = $html . "</FORM>";
	return $html;
}
...
//	write out all $_POST attributes as hidden input
	...
	if (is_officer($e_id)) 
	{
		if($_POST['show_office'])
		{
			...
			$html = $html."<input type='submit' value='   Hide Offices   '></FORM>";
		} else
		{
			$html = $html."<input type='hidden' name='show_office' value=1>";
			$html = $html."<input type='submit' value='   Show Offices   '></FORM>";
		}
	} else
	{
		$html = $html."<input type='hidden' name='show_office' value=0>";
			$html = $html."<input type='submit' value='     NO Office    '></FORM>";
	}
	return $html;
}
