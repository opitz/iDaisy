...
//	show_unit_specs($au_data);
	...
	show_programmes_by_year();
	if($show_unit_teaching) show_unit_teaching_details_by_year();
	if($show_enrollment) show_enrollment_details_by_year();
}
...
//	define column width in table
	$table_width = array('Term' => 50, 'Department' => 300, 'Subject' => 350, 'Type' => 350, 'Assessment Units (Students)' => 350);
...
function unit_switchboard()
{
	...
	print "<TD WIDTH=200 ALIGN=LEFT>".unit_teaching_button()."</TD>";
	print "<TD WIDTH=200 ALIGN=LEFT>".unit_enrollment_button()."</TD>";
