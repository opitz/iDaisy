...
//dprint($query);
	...
	if(dtc_flag_is_set($au_id)) print "<BR />Available for DTC";
	print "<P>";
}

//--------------------------------------------------------------------------------------------------
function dtc_flag_is_set($au_id)
//	check if the AU is ment to be available to the DTC
{
