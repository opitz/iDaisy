...
$version = '120528.1';
$version = '120529.1';			// bugfix: enrolment_exists($row, $ay_id)
$version = '120619.4';			// fixed duplicate bug
$version = '120703.1';			// re-import data for 12-07-03
$version = '121113.2';			// add file upload

include '../includes/opendb.php';
include '../includes/common_functions.php';
include '../includes/common_DAISY_functions.php';

$ay_id = 5;												// set the academic year
...
//		if($row['DAISY ID'] != '' AND $row['au_code'] != '')
		if($row['DAISY ID'] != '' AND $row['au_code'] != '' AND $row['status'] == 'CONFIRMED')
		{
