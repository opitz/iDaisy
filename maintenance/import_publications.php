...
//=============================================================================================================
//
//	Script to update publication data from the CSV file following the REF stucture
//	
//	Last Update by Matthias Opitz, 2013-01-24
//
//=============================================================================================================
$version = '121219.1';
$version = '130111.1'; // added security
$version = '130114.1'; // added NULL to ID fields when < 1
$version = '130124.3'; // ...
//==============================================< Here we go! >====================================================
...
//			test_publication_data();
			...
			if($d_id)
			{
				if($_POST['replace']) delete_publications($d_id);
				import_publication_data($d_id);
//				update_authors($d_id);
			}
			else 
...
//--------------------------------------------------------------------------------------------------
function import_publication_data($d_id)
{
	$publication_file = $_FILES['file']['name'];
	$publication_tmp_file = $_FILES['file']['tmp_name'];
	$publication_table = csv2table($publication_tmp_file, 1);
...
//	print "Journal '$title' has been added.<BR />";
	return mysql_insert_id();
}
