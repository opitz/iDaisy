...
//==================================================================================================
//
//	iDAISY Teaching Review Report index page
//	Last changes: Matthias Opitz --- 2013-03-18
//
//==================================================================================================
$version = "130318.1";

include 'teaching_review_include_list.php';
...
$header = "Department Teaching Review Report";

if($_POST['query_type'] == 'teaching_review') 
{
	$header = "Department Teaching Report";
	$table = teaching_review_report();
}

//	show the results
show_header($header);

if(current_user_is_in_DAISY_user_group("Editor")) show_teaching_review_query();
else show_no_mercy();
